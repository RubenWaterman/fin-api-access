...
defmodule FinAPIAccess.Api.Authorization do
  ...
  """
  @spec get_token(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, FinAPIAccess.Model.AccessToken.t} | {:error, Tesla.Env.t}
  def get_token(connection, grant_type, client_id, client_secret, opts \\ []) do
    ...
    |> decode(%FinAPIAccess.Model.AccessToken{})
  end
  ...
  {:error, info} on failure
  """
  @spec revoke_token(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
