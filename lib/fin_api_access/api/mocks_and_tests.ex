...
defmodule FinAPIAccess.Api.MocksAndTests do
  ...
  - check_categorization_data (CheckCategorizationData): Transactions data
  ...
  """
  @spec check_categorization(Tesla.Env.client, FinAPIAccess.Model.CheckCategorizationData.t, keyword()) :: {:ok, FinAPIAccess.Model.ErrorMessage.t} | {:ok, FinAPIAccess.Model.BadCredentialsError.t} | {:ok, FinAPIAccess.Model.CategorizationCheckResults.t} | {:error, Tesla.Env.t}
  def check_categorization(connection, check_categorization_data, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/api/v1/tests/checkCategorization")
    |> add_param(:body, :body, check_categorization_data)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %FinAPIAccess.Model.CategorizationCheckResults{}},
  ...
  - connection (FinAPIAccess.Connection): Connection to server
  - mock_batch_update_params (MockBatchUpdateParams): Data for mock bank connection updates
  - opts (KeywordList): [optional] Optional parameters
  ## Returns
  ...
  {:error, info} on failure
  """
  @spec mock_batch_update(Tesla.Env.client, FinAPIAccess.Model.MockBatchUpdateParams.t, keyword()) :: {:ok, nil} | {:ok, FinAPIAccess.Model.ErrorMessage.t} | {:ok, FinAPIAccess.Model.BadCredentialsError.t} | {:error, Tesla.Env.t}
  def mock_batch_update(connection, mock_batch_update_params, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/api/v1/tests/mockBatchUpdate")
    |> add_param(:body, :body, mock_batch_update_params)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, false},
